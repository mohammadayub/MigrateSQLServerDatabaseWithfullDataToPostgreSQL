...
namespace ConversionMSSQLTOPOSTGRESQL
{
    /// <summary>
    /// Copy Sql Server catalog to PostgreSQL ("DatabaseName" in debug mode).
    ...
    class Program
    {
        ...
        /// </summary>
        public static string Server = @"DELL\MSSQLSERVER2017";
        ...
        public static string Password2 = @"123@abc";
        ...
        /// </summary>
        public static int DatabasePort2 = 5433;
        ...
        /// Use "Database Name " (in Debug mode)
        ...
        public static bool CheckSqlServer(ref string connectionStringSqlServer)
        {
            ...
            using (var msConnection = new SqlConnection(connectionStringSqlServer))
            {
                ...
                if (result)
                {
                    Console.WriteLine(" Welcome to NSIA Conversion Application SQL Server Express " + msConnection.ServerVersion);
                }
                else
                {
        ...
        public static string OpenPostgreSql(string connectionStringPostgresql)
        {
            ...
            if (catalogExists)
            {
                ...
                {
                    // DROP DATABASE.
                    // Connection to main database "postgres", typically with: username "postgres", password "123@abc".
                        ...
                        foreach (DataRow rowTable in dt.Rows)
                        {
                           ...
                           // Database.ExecuteSqlScript(this.ConnectionStringPostgresql, "DELETE FROM " + pgTablename + ";");
                            ...
                            using (var dr = command.ExecuteReader(CommandBehavior.Default))
                            {
                                ...
                                // Create insert query with column names and @ parameter List.
                                ...
                                Console.WriteLine("Inserted " + pgInsertedCount + " records.");
        ...
        public static string GetFieldInformation(SqlConnection msConnection, string msTablename, ref List<string> msColumns, ref string schema)
        {
            ...
            pgCreateFields = pgCreateFields.Replace(" Numeric ", " integer ");
            pgCreateFields = pgCreateFields.Replace(" ntext ", " text ");
            pgCreateFields = pgCreateFields.Replace(" sql_varient ", " text ");
...
";
        ...
        public static string GetConnectionString(string sqlServer, string catalog, string username, string password)
        {
            ...
            {
                connectionString = string.Format(@"Integrated Security=true;Persist Security Info=False;Data Source={0}", sqlServer);
            }
